        ...
        <div className="flex  flex-col items-center">
          ...
          <div className="w-72 h-72 bg-white rounded-xl flex flex-col justify-between items-center py-8 drop-shadow-md">
            ...
            <div className="relative mb-6">
              ...
              <input type="text" placeholder='Insira seu nickname' className="border-[#F1F1F1] border h-10 w-48 bg-gray-50 font-bold text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
            </div>
            <div className="w-32">
              <Botao onClick={() => {
                navigate("/home")
